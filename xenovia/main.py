...
if __name__ == '__main__':
    ...
    # Initialize Printer
    thread_printer = Printer(main_window) #No need to pass UI referance? this would be a standalone API
    thread_printer.start()
       
    main_window.setHandlePrinter(thread_printer) # Passes the  Printer object to the Main UI
